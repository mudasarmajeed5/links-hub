...
const Frontpage = () => {
  return (
    <div className='overflow-clip font-serif'>
      <div className="flex flex-col justify-center min-h-[80vh] md:flex-row font-[Poppins] bg-slate-300 text-black pt-20">
        <div className="flex md:px-6 xl:ml-6 px-3 items-center justify-center gap-4 flex-col">
          <h1 className="text-2xl font-serif font-bold md:text-3xl xl:text-5xl">Everything you are. In one, simple link in bio.</h1>
          <p className='text-xl '>Join people using <span className="font-bold">follow tree</span> for their link in bio. One link to help you share everything you create, curate and sell from your Instagram, TikTok, Twitter, YouTube and other social media profiles.</p>
        </div>
        <div className="flex justify-center items-center">
          <img className='w-9/12' src="/pngtree.png" alt="" />
        </div>
      </div>
