...
export const features = [
  {
    ...
    text: "With LinksHub, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
    button: {
  ...
  },
  {
    ...
    text: "Your data security is our priority. With state-of-the-art encryption and robust privacy controls, LinksHub helps keep your information secure and locked up tighter than Fort Knox.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to set up LinksHub?",
  ...
  {
    id: "1",
    question: "Can I integrate LinksHub with other platforms?",
    answer: "Absolutely! Not only can you upgrade your plan at any time, but you also get a prorated discount, giving you maximum value for your subscription.",
  },
  {
    id: "2",
...
export const testimonials = [
  {
    ...
    comment: "LinksHub's customization options are fantastic! My page feels truly unique.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment: "I was skeptical at first, but now I can't imagine my personal brand without it.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment: "Setting up was super easy. It took me just a few minutes to get my page live!",
  },
  {
    id: "3",
    name: "Alicia Barker",
    ...
    comment: "The analytics feature has been a game-changer for tracking engagement.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment: "Switched to LinksHub last month, and I’m already seeing better engagement.",
  },
  {
    id: "5",
    name: "Jim Bradley",
    ...
    comment: "The level of customization available is fantastic. It truly fits my brand!",
  },
];
export const logos = [
  {
...
export const links = [
  ...
  },
  {
    id: "3",
    title: "Web",
    icon: <FaGlobe />, // Globe icon for web
    url: "#",
  },
];
